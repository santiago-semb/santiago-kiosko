...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/brahma.jpg">
    <title>Brahma | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=brahma" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_brahma ORDER BY LITROS DESC";
