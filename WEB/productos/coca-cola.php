...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/coca-cola/formulario-producto-individual.php" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    <?php
        ...
        <div style='display: inline-block; height: 300px;'>
            ...
            <!-- boton ver -->
            <a href='../../backend/ver-producto-individual/coca-cola/ver-producto-individual.php?ID=<?php echo $datos->ID ?>'>   
