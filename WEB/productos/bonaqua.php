...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/bonaqua.jpg">
    <title>Bon aqua | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=bonaqua" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_bonaqua ORDER BY LITROS DESC";
