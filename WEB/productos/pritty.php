...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/pritty.jpg">
    <title>Pritty | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=pritty" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_pritty ORDER BY LITROS DESC";
