...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/quilmes.png">
    <title>Quilmes | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=quilmes" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_quilmes ORDER BY LITROS DESC";
