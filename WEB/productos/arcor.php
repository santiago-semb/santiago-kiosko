...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/arcor.jpg">
    <title>Arcor | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=arcor" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_arcor ORDER BY ID";
