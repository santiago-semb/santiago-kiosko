...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/pasodelostoros.png">
    <title>Paso de los toros | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=pasodelostoros" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_pasodelostoros ORDER BY LITROS DESC";
