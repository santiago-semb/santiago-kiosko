...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/villadelsur.png">
    <title>Villa del sur | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=villadelsur" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_villadelsur ORDER BY LITROS DESC";
