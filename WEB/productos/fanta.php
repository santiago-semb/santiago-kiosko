...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/fanta.png">
    <title>Fanta | Kiosko</title>
...
<?php 
    ...
    $query = "SELECT * FROM producto_individual_fanta ORDER BY LITROS DESC";
...
?>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=fanta" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
