...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/budweiser.png">
    <title>Budweiser | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=budweiser" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_budweiser ORDER BY LITROS DESC";
