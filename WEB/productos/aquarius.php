...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/aquarius.png">
    <title>Aquarius | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=aquarius" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_aquarius ORDER BY LITROS DESC";
