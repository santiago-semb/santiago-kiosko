...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/monster.png">
    <title>Monster | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=monster" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_monster ORDER BY LITROS DESC";
