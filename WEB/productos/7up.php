...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/7up.jpg">
    <title>7up | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=7up" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_7up ORDER BY LITROS DESC";
