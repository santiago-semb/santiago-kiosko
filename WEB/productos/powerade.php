...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/powerade2.png">
    <title>Powerade | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=powerade" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_powerade ORDER BY LITROS DESC";
