...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/redbull.png">
    <title>Red bull | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=redbull" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_redbull ORDER BY LITROS DESC";
