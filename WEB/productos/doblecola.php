...
<body>
    ...
    <?php
        ...
        <div style='display: inline-block; height: 300px;'>
            ...
            <a href='../../backend/ver-producto-individual/ver-producto-individual.php?ID=<?php echo $datos->ID ?> & nom=<?php echo $datos->NOMBRE ?>' class='cuadro-producto'><img id='imagen-productos' src='image-individual/<?php echo $datos->IMAGEN ?>' style="font-size:50px;"></a>
