...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/terrabusi.jpg">
    <title>Terrabusi | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=terrabusi" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_terrabusi ORDER BY ID";
