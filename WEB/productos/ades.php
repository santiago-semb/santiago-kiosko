...
<head>
    ...
    <link rel="shortcut icon" href="../assets/logo-inferior/ades.jpg">
    <title>Ades | Kiosko</title>
...
<body>
    ...
    <div id="h1-productos">
        <a href="../../backend/insertar-producto-individual/formulario-producto-individual.php?nom=ades" style="list-style: none;"><button>Añadir producto</button></a>
    </div>
    ...
    $query = "SELECT * FROM producto_individual_ades ORDER BY LITROS DESC";
